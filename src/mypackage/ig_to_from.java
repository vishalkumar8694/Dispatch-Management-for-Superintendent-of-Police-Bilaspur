 ...
 */
public class ig_to_from extends javax.swing.JFrame {

    /**
     * Creates new form ig_to_from
     */
    public ig_to_from() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ig_to_from.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ig_to_from().setVisible(true);
            }
        });
    }
