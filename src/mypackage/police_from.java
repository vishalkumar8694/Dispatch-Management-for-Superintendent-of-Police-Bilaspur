 ...
 */
public class police_from extends javax.swing.JFrame {
 Connection con=null;
     ...
     void last_data_from()
    {
         try
        {
            ...
            ResultSet rs=st.executeQuery("select *from sp where pref_no=3 ");
            String srno;
            String from;
    ...
    private void initComponents() {
        ...
        jPanel1.add(submit);
        submit.setBounds(1020, 530, 110, 30);
        ...
        jLabel5.setText("से");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(420, 280, 160, 30);
        ...
        jPanel1.add(jLabel7);
        jLabel7.setBounds(660, 200, 180, 30);
        ...
        jLabel13.setBounds(150, 560, 190, 30);

        txtfrom.setFont(new java.awt.Font("Arial Unicode MS", 0, 14)); // NOI18N
        txtfrom.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DGP Chattisgarh", "Acct./Welfare/Traffic", "ADMN", "AJK", "ANO", "CAF & STF", "CID", "INT", "P/P&Tech.ServiceSB", "Security", "SIB", "Rail/Traffic", "Training", "Welfare", "Radio", "others" }));
        ...
        jPanel1.add(txtfrom);
        txtfrom.setBounds(380, 320, 180, 30);
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        try {
          ...
          pstmt=con.prepareStatement("insert into police_f(serial_no,recieved_date,from1,letter_no,letter_no_date,to1,remarks,matter)values(?,?,?,?,?,?,?,?)");
            ...
            d2=d2.trim();
            String r=txtfrom.getSelectedItem().toString();
            if(r.equals("others"))
            {
            ...
            if(n.length()>0 &&letter_no.length()>0&&d1.length()>0&&d2.length()>0 && to.length()>0&&r.length()>0)
           {
            ...
            if(i>=0)
            {
                ...
                try {
                    ...
                    String r1=txtfrom.getSelectedItem().toString();
                    ...
                    else
                    {
                     ...
                     JOptionPane.showMessageDialog(null,"Please check letter number mkp"+ex,"Insertion  alert",JOptionPane.ERROR_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(police_from.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new police_from().setVisible(true);
            }
        });
    }
